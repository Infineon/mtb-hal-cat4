...
#define wreg32(r, v)            ({*(volatile uint32 *)(r) = (uint32)(v); __COMPILER_BARRIER();})
#define rreg32(r)               (*(volatile uint32 *)(r))
#define wreg16(r, v)            ({*(volatile uint16 *)(r) = (uint16)(v); __COMPILER_BARRIER();})
#define rreg16(r)               (*(volatile uint16 *)(r))
#define wreg8(r, v)             ({*(volatile uint8 *)(r) = (uint8)(v); __COMPILER_BARRIER();})
