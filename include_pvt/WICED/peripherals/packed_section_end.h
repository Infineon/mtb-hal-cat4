 ...
 */
    ...
    #undef CYHAL_PACKED_STRUCT
#else
    #error "CYHAL_PACKED_STRUCT is NOT defined!"
#endif
     ...
     * CYHAL_PRE_PACKED_STRUCT and CYHAL_POST_PACKED_STRUCT defined in
     * typedefs.h
     */
 ...
 * so, undef them here.
 */
#undef    CYHAL_PRE_PACKED_STRUCT
#undef    CYHAL_POST_PACKED_STRUCT
