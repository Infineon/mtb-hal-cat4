...
#define D64_XC_LE           0x00000004    /* loopback enable  When set, causes all TX channel data to be looped back to the RX channel. When
                                                        cleared, transmit data is sent to the core. Some cores do not support this operation; for
                                                        details, see the documentation for each core */
...
#define D64_CTRL1_NOTPCIE    ((uint32)1 << 18)  /* This field encodes the burst length, in bytes,
                                                 * used by the transmit DMA engine for data reads from memory.
                                                 * (not descriptor prefetch). In general, access to cores
                                                 * other than PCIE should not use burst lengths
                                                 * greater than 64B
                                                 */
