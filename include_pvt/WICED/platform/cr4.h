...
{
    uint32_t value;
    __ASM( "mrc p15, 0, %0, c6, c0, 2" : "=r" (value) : );
    return value;
}
...
{
    uint32_t value;
    __ASM( "mrc p15, 0, %0, c5, c0, 1" : "=r" (value) : );
    return value;
}
...
{
    uint32_t value;
    __ASM( "mrc p15, 0, %0, c6, c0, 0" : "=r" (value) : );
    return value;
}
...
{
    uint32_t value;
    __ASM( "mrc p15, 0, %0, c5, c0, 0" : "=r" (value) : );
    return value;
}
...
static inline void cr4_init_cycle_counter( void )
{
    ...
    __ASM volatile ("MCR p15, 0, %0, c9, c12, 0" : : "r"(0x00000005));
...
{
    uint32_t count;
    __ASM volatile ("MRC p15, 0, %0, c9, c13, 0" : "=r"(count));
    return count;
}
...
{
    uint32_t flag;
    __ASM volatile ("MRC p15, 0, %0, c9, c12, 3" : "=r"(flag));
    return flag;
}
