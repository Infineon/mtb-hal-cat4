...
extern cy_rslt_t wwd_buffer_init( /*@null@*/ void* native_arg );
...
extern cy_rslt_t wwd_buffer_deinit( void );
...
extern cy_rslt_t internal_host_buffer_get( /*@special@*/ /*@out@*/ wiced_buffer_t* buffer, wwd_buffer_dir_t direction, unsigned short size, unsigned long timeout_ms ) /*@allocates *buffer@*/  /*@defines **buffer@*/;
...
extern cy_rslt_t host_buffer_get( /*@special@*/ /*@out@*/ wiced_buffer_t* buffer, wwd_buffer_dir_t direction, unsigned short size, bool wait ) /*@allocates *buffer@*/  /*@defines **buffer@*/;
 ...
 * @return CY_RSLT_SUCCESS = Success, Error code = Failure
 */
extern cy_rslt_t host_buffer_set_size( /*@temp@*/ wiced_buffer_t buffer, unsigned short size );
 ...
 * @return CY_RSLT_SUCCESS = Success, Error code = Failure
 */
extern cy_rslt_t host_buffer_add_remove_at_front( wiced_buffer_t* buffer, int32_t add_remove_amount ); /* Adds or removes buffer parts as needed (and returns new handle) - new bytes must be contiguous with each other, but not necessarily with original bytes */


extern cy_rslt_t host_buffer_set_next_piece(wiced_buffer_t buffer, wiced_buffer_t next_buffer );
