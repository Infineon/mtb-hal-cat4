...
#define CY_BLOCK_COUNT_ETHERNET (1)
...
#define CY_OFFSET_ETHERNET (CY_OFFSET_DMA + CY_SIZE_DMA)
#define CY_SIZE_ETHERNET   CY_BLOCK_COUNT_ETHERNET
#define CY_OFFSET_GPIO     (CY_OFFSET_ETHERNET + CY_SIZE_ETHERNET)
 ...
 * actually present. */
static const _cyhal_hwmgr_offset_t cyhal_block_offsets_clock[13] =
{
    0, // ALP,
    1, // HT,
    2, // ILP,
