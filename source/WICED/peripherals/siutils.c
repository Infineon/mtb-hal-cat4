...
{
    (void)pcidev; // Unused parameter warning
    (void)regs; // Unused parameter warning
    (void)bustype; // Unused parameter warning
    (void)sdh; // Unused parameter warning
    (void)vars; // Unused parameter warning
    (void)varsz; // Unused parameter warning
...
{
    (void)sih; // Unused parameter warning
    (void)coremask; // Unused parameter warning
}
